...
import com.abhi41.jetvalideform.ui.theme.JetValideFormTheme
...
fun RegistrationFormScreen(
    ...
    //we can aslo do this but we impl dagger hilt
    ...
    Column(
        ...
        Button(onClick = {
            viewModel.onEvent(RegistrationFormEvents.Sumbit)
        }, modifier = Modifier.align(Alignment.End)) {
            Text(text = "Submit")
        }
    }
